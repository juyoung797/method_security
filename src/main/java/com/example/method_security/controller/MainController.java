...
import com.example.method_security.dto.AdvancedPageDto;
import com.example.method_security.dto.CreatePostRequest;
import com.example.method_security.dto.UserDto;
import com.example.method_security.model.Department;
import com.example.method_security.model.Post;
import com.example.method_security.model.Role;
import com.example.method_security.model.User;
import com.example.method_security.service.AdvancedSecurityService;
import com.example.method_security.service.PostService;
import com.example.method_security.service.UserService;
...
public class MainController {
    ...
    public String posts(Authentication authentication, Model model) {
        User currnetUser = (User) authentication.getPrincipal();

        List<Post> posts = postService.getAllPosts();
        model.addAttribute("posts", posts);
        model.addAttribute("currentUser", currnetUser);
    ...
    public String deletePost(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("message", "게시글 삭제되었습니다");
        } catch (AccessDeniedException e) {
    ...
    public String perfromSensitiveOperation(RedirectAttributes redirectAttributes) {
        try {
